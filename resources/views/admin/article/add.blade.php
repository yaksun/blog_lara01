        ...
        <form action="{{url('admin/article')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="art_title"><span>文章标题必须填写</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <th></th>
                    <td>
                        <img  alt="" id="art_thumb_src" style="max-width: 350px; max-height: 200px">
                    </td>
                </tr>
               <tr>
                    <th>介绍：</th>
                    <td>
                        <input type="text" name="art_intro"  class="lg">
                    </td> 
                </tr>
                <tr>
                    <th>文章内容：</th>
