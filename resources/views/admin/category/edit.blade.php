        ...
        <form action="{{url('admin/category').'/'.$field->cate_id}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="cate_name" class="lg" value="{{$field->cate_name}}">
                    </td>
                </tr>
                <tr>
                    <th>标题</th>
                    <td>
                        <input type="text" name="cate_title" class="lg"  value="{{$field->cate_title}}">
                    </td>
                </tr>
               ...
               {{-- <tr>
                    <th>描述：</th>
                    <td>
                        <input type="text" name="cate_description" value="{{$field->cate_description}}"  class="lg">
                    </td>
                </tr>
                <tr>
                    <th>关键字：</th>
                    <td>
                        <input type="text" name="cate_keywords"  value="{{$field->cate_keywords}}" class="lg">
